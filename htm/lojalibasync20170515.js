...
(function () {
  ...
  if (FC$.Page == "Cart") {
    zF$.fnChangeInnerText("#FCCartFreightSimulationBut", "Simular frete");
    zF$.fnChangeInnerText("#FCCartRecalculateBut", "Atualizar");
    zF$.fnChangeInnerText("#idTxtRecalculateFC b", "Atualizar");
	zF$.fnChangeInnerText(".FCCartCupomLabel", "Simular frete");
    zF$.fnChangeInnerText("#FCCartStillShoppingBut","<< Continuar Comprando");
    zF$.fnChangeInnerText("#FCCartBuyBut","Próximo Passo >>");
  }
